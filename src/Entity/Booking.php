...
class Booking
{
    ...
    /**
     * Permet de récupérer un tableau des journées qui coresspondent à ma réservation
     *
     * @return array Un tableu d'objets DatetTime représentant les jours de la réservation
     */
    ...
    public function getDuration(){
        //diff permet de faire une différence entre deux dates    
