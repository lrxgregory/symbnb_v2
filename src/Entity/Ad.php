 ...
 * @ORM\HasLifecycleCallbacks //Prévient Doctrine qu’il y a des fonctions liées au cycle de vie
 * @UniqueEntity(
 *  fields={"title"},
*   message="Une autre annonce possède déjà ce titre, merci de bien vouloir modifier le titre"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=20, minMessage="Votre introduction ne peut pas faire moins de 20 caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre introduction ne peut pas faire moins de 100 caractères")
     */
    private $content;
    ...
    /**
     * Permet de calculer la moyenne d'une annonce
     *
     * @return float
     */
